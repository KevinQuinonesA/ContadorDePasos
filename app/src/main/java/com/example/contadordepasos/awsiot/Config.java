...
public class Config {
    ...
    public static String topic_step_sensor_publicar = "sensor/1/stepcounter/publicar";
    public static String topic_step_sensor_subscribe = "sensorstepcountersubscribir";

    public static String topic_acelerometer_publicar = "sensor/1/acelerometer/publicar";
